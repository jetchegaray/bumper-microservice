...
angular.module('amApp').controller('QuoteDetailsController', QuoteDetailsController)

function QuoteDetailsController($state, $stateParams, $window, productService, userService, planService, paymentService, redirectService, errorService) {
  const $ctrl = this
